...
def introduction():
    ...
    with col1:
        st.sidebar.markdown('''📖 [Source Code](https://github.com/SUYASH6969/Advanced-Product-Segmentation-using-Python-Insights-for-Business-Decision-Making)''')
    with col2:
        st.sidebar.markdown('''👁️‍🗨️ [User Guide](https://github.com/SUYASH6969/Advanced-Product-Segmentation-using-Python-Insights-for-Business-Decision-Making)''')
